...
\newcommand{\workpositionentry}[4]{
  {\large\textit{\textbf{#1}}}\expandafter\ifstrequal\expandafter{#2}{}{}{\hfill\textsc{#2}}\par % Job title and Duration 
%	\expandafter\ifstrequal\expandafter{#3}{}{}{{\raggedright\large #3}\\} % Employer
  \expandafter\ifstrequal\expandafter{#3}{}{}{{\raggedright\textit{#3}}\\} % Employer
%	\expandafter\ifstrequal\expandafter{#4}{}{}{{\raggedright\large\textit{\textbf{#4}}}\\[4pt]} % Job title
%	\expandafter\ifstrequal\expandafter{#4}{}{}{#4\\} % Description
 	\expandafter\ifstrequal\expandafter{#4}{}{}{#4\smallskip} % Description
}
