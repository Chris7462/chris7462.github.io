...
![Opening the Pixel 8](./img/pixel8-open.jpeg)

![Screen separated from frame](./img/pixel8-separated.jpeg)

After reassembly, the new screen boots up but the fingerprint sensor needs recalibration:

![New screen booting up with calibration notice](./img/pixel8-newscreen.jpeg)
