...
\begin{itemize}[noitemsep,nolistsep]
  ...
  \item[] Research Assistant - Computational Mathematics Science and Engineering \hfill Jan.~2016 -- Dec.~2016
    \begin{itemize}[noitemsep,nolistsep]
      ...
      \item Work in neuroimaging data for brain activity.
...
\begin{itemize}[noitemsep,nolistsep]
  ...
  \item \href{https://github.com/Chris7462/Monte-Carlo-EM-Algorithm}{\textbf{MCEM}}: An \textsf{R} function with Mwanza example that realizes the method proposed by Richard A.~Levine and George Casella (2001) in their paper: \href{https://www.jstor.org/stable/1391097}{Implementation of the Monte Carlo EM Algorithm}.
\end{itemize}
