...
\begin{itemize}[noitemsep,nolistsep]
  \item[] Lead Engineer, Autonomous and Artificial Intelligence -- Advanced Engineering \hfill Jun 2024 -- Present
    \begin{itemize}[noitemsep,nolistsep]
      \item Deployment of perception components on TesorRT:
      ...
      \item Research on Transformer based Perception tasks.
      \item  Research on manifold (matrix Lie group) for autonomous vehicle localization.
    \end{itemize}
