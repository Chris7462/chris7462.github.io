...
\begin{itemize}[noitemsep,nolistsep]
  ...
  \item[2.] \textbf{Zhang, Y.-C.} (2020). \textit{Road Geometry Estimation Using Vehicle Trails: A Linear Mixed Model Approach}. (submitted to IEEE Transactions on Vehicular Technology)
