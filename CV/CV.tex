...
\begin{itemize}[noitemsep,nolistsep]
  ...
  \item[1.] \textbf{Zhang, Y.-C.} (2021+). \textit{Road Geometry Estimation Using Vehicle Trails: A Linear Mixed Model Approach}. (submitted to Journal of Intelligent Transportation Systems)
