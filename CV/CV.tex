...
\begin{itemize}[noitemsep,nolistsep]
    ...
    \begin{itemize}[noitemsep,nolistsep]
      \item Develop curb detection using 3D LiDAR point cloud data:\\
        Moriyama dataset demo for \href{https://chris7462.github.io/Demo/moriyama.mp4}{3D LiDAR curb detection}.
    \end{itemize}
\end{itemize}
