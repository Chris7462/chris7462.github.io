...
\begin{itemize}[noitemsep,nolistsep]
  \item[] Software Lead -- PVRD Team \hfill Jul.~2021 -- Present
    \begin{itemize}[noitemsep,nolistsep]
    ...
    \end{itemize}
	\item[] Autonomous Driving Engineer -- PVRD Team \hfill Jan.~2021 -- Jun.~2021
    \begin{itemize}[noitemsep,nolistsep]
...
\begin{itemize}[noitemsep,nolistsep]
  ...
  \item[1.] \textbf{Zhang, Y.-C.} (2021). \textit{Road Geometry Estimation Using Vehicle Trails: A Linear Mixed Model Approach}. Journal of Intelligent Transportation Systems (Accepted).
