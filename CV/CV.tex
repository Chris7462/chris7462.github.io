...
\begin{itemize}[noitemsep,nolistsep]
  \item[] Lead Engineer, Autonomous and Artificial Intelligence -- Advanced Engineering \hfill Jun 2024 -- Present
    \begin{itemize}[noitemsep,nolistsep]
      \item Lead the Autonomous Driving Kit workstream development with the focus on Perception and Localization components.
      \item Develop state-of-art Invariant EKF for state estimation and fusion.
    \end{itemize}
